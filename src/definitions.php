...
if (!defined('FORMSLIB_STYLE_BOOTSTRAP5_HORIZONTAL')) define('FORMSLIB_STYLE_BOOTSTRAP5_HORIZONTAL', 7);
if (!defined('FORMSLIB_STYLE_BOOTSTRAP5_INLINE')) define('FORMSLIB_STYLE_BOOTSTRAP5_INLINE', 8);
if (!defined('FORMSLIB_STYLE_BOOTSTRAP5_VERTICAL')) define('FORMSLIB_STYLE_BOOTSTRAP5_VERTICAL', 9);

if (!defined('FORMSLIB_STYLES_ALL_BOOTSTRAP'))
{
	define('FORMSLIB_STYLES_ALL_BOOTSTRAP', [
		FORMSLIB_STYLE_BOOTSTRAP,
		FORMSLIB_STYLE_BOOTSTRAP3,
		FORMSLIB_STYLE_BOOTSTRAP3_INLINE,
		FORMSLIB_STYLE_BOOTSTRAP3_VERTICAL,
		FORMSLIB_STYLE_BOOTSTRAP5_HORIZONTAL,
		FORMSLIB_STYLE_BOOTSTRAP5_INLINE,
		FORMSLIB_STYLE_BOOTSTRAP5_VERTICAL
	]);
}

if (!defined('FORMSLIB_STYLES_ALL_BOOTSTRAP_GE_3'))
{
	define('FORMSLIB_STYLES_ALL_BOOTSTRAP_GE_3', [
		FORMSLIB_STYLE_BOOTSTRAP3,
		FORMSLIB_STYLE_BOOTSTRAP3_INLINE,
		FORMSLIB_STYLE_BOOTSTRAP3_VERTICAL,
		FORMSLIB_STYLE_BOOTSTRAP5_HORIZONTAL,
...
if (!defined('FORMSLIB_STYLES_ALL_BOOTSTRAP_GE_5'))
{
	define('FORMSLIB_STYLES_ALL_BOOTSTRAP_GE_5', [
		FORMSLIB_STYLE_BOOTSTRAP5_HORIZONTAL,
		FORMSLIB_STYLE_BOOTSTRAP5_INLINE,
		FORMSLIB_STYLE_BOOTSTRAP5_VERTICAL
	]);
